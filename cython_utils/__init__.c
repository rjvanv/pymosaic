...
{
    "distutils": {
        "name": "cython_utils.__init__",
        "sources": [
            "/home/rjvanvoorhis/git/photomosaic-v2/src/cython_utils/__init__.py"
        ]
    },
    "module_name": "cython_utils.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cython_utils____init__
#define __PYX_HAVE_API__cython_utils____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'cython_utils.__init__' */
#define __Pyx_MODULE_NAME "cython_utils.__init__"
extern int __pyx_module_is_main_cython_utils____init__;
int __pyx_module_is_main_cython_utils____init__ = 0;

/* Implementation of 'cython_utils.__init__' */
...
static PyObject *__pyx_n_u_cython_utils;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_cython_utils, __pyx_k_cython_utils, sizeof(__pyx_k_cython_utils), 0, 1, 0, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_cython_utils____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_cython_utils) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_utils.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_utils.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
